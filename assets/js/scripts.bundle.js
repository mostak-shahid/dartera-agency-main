...
var KTApp = (function () {
    ...
    var setThemeMode = function (mode, cb) {
        ...
        if (mode === "dark") {
            Promise.all([loadCssFile("plugins.bundle.css", "plugins.dark.bundle.css"), loadCssFile("style.bundle.css", "style.dark.bundle.css")])
                .then(function () {
                    // Set dark mode class
            ...
            Promise.all([loadCssFile("plugins.dark.bundle.css", "plugins.bundle.css"), loadCssFile("style.dark.bundle.css", "style.bundle.css")])
                .then(function () {
